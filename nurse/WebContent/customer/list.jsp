				...
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<tr
							...
							<td align="center" width="17%">病人名称</td>
						...
						<c:forEach var="c" items="${ list }" varStatus="vs">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="17%"><a
									href="${ pageContext.request.contextPath }/UserServlet?method=findById&id=${c.id}">
					
								${c.username }</a></td>
								
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="17%">${c.idcard }</td>
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/UserServlet?method=editUI&id=${c.id}">
										<img
										src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand">
								</a></td>
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/UserServlet?method=delete&id=${c.id}">
										<img
